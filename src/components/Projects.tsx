  ...
  return (
    <section id="projects" className="section-padding bg-surface/50 relative">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 xl:gap-10 justify-center">
              ...
              <div className="tilt-card-inner card-elegant group relative overflow-visible animate-project-fade-in h-full flex flex-col" style={{ animationDelay: `${index * 120}ms` }}>
                <div className="relative overflow-hidden rounded-t-lg">
                  {project.title === "TickerPulse — AI-Powered Stock Sentiment Analysis & Trend Prediction Platform" ? (
                    ...
                    <div className="h-48 xl:h-56 2xl:h-64 bg-gradient-subtle flex items-center justify-center animate-emoji-bounce">
                ...
                <CardContent className="p-6 xl:p-8 space-y-4 xl:space-y-5 flex-1 flex flex-col">
                  <div className="space-y-2">
                    <h3 className="text-xl xl:text-2xl 2xl:text-3xl font-semibold group-hover:text-primary transition-colors duration-300">{project.title}</h3>
                    <p className="text-muted-foreground text-sm xl:text-base 2xl:text-lg line-clamp-3">
                      {project.description}
                    </p>
                  </div>

                  {/* Technologies */}
                  <div className="flex flex-wrap gap-1.5 xl:gap-2 mt-4">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span key={tech} className="px-2.5 py-1 xl:px-3 xl:py-1.5 bg-primary/10 text-primary text-xs xl:text-sm 2xl:text-base rounded-md animate-tech-fade-in">
                        {tech}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="space-y-2 mt-4">
                    <h4 className="font-medium text-sm xl:text-base 2xl:text-lg">Key Features:</h4>
